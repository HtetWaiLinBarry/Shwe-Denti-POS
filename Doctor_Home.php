...
<body id="body">
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <?php echo "<li class='menu-has-children'><a href=''>Menu</a>";
            echo "<ul>";
              echo "<li><a href='Help.php?did=$did'>Help</a></li>";
              echo "<li><a href='#'>Contents</a></li>";
              echo "<li><a href='#'>Send a Report</a></li>";
            echo "</ul>";
          echo "</li>";
          echo "<li><a href='#contact'>Contact</a></li>";
          echo "<li><a href='Doctor_Profile.php?did=$did'>View My Profile</a></li>";
          ?>
        </ul>
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      ...
      <div>
        <?php echo "<a href='Doctor_Order.php?did=$did' class='btn-get-started scrollto'>Order Now!</a>" ?>
        <a href="#portfolio" class="btn-projects scrollto">Things We Do</a>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-9 text-center text-lg-left">
            ...
            <p class="cta-text">Book for Crowns, Bridges and Implants now and we will make it for you as fast as possible.</p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            <?php echo "<a class='cta-btn align-middle' href='Doctor_Order.php?did=$did'>Order Now!</a>"; ?>
          </div>
        </div>
